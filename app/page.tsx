...
export default function Component() {
  ...
  const [activePortfolioTab, setActivePortfolioTab] = useState("marketing")
  ...
  const services = [
    { name: "Digital Marketing", icon: Megaphone, description: "We create and implement comprehensive digital marketing strategies to boost your online presence and drive growth." },
    { name: "Graphic/UI-UX Design", icon: Layout, description: "We create visually stunning designs and intuitive user interfaces that capture your brand's essence and enhance user experiences." },
  ...
  const portfolioItems = {
    marketing: [
      { title: "Social Media Campaign for Tech Startup", image: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=300&h=200&fit=crop" },
      { title: "SEO Optimization for E-commerce Site", image: "https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=300&h=200&fit=crop" },
      { title: "Email Marketing Strategy for SaaS", image: "https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?w=300&h=200&fit=crop" },
    ],
    design: [
  ...
  const testimonials = [
    { name: "Rajesh Kumar", role: "CEO, TechInnovate India", content: "Sanganak's expertise in AI solutions has revolutionized our business processes. Their team's dedication and innovative approach exceeded our expectations." },
    { name: "Priya Sharma", role: "Founder, DesignHub Mumbai", content: "The UI/UX design Sanganak created for our app was nothing short of brilliant. It significantly improved user engagement and satisfaction." },
    { name: "Amit Patel", role: "CTO, EduTech Bangalore", content: "Working with Sanganak on our e-learning platform was a game-changer. Their web development skills and attention to detail are unparalleled." },
    { name: "Neha Gupta", role: "Marketing Director, GrowthCo Delhi", content: "Sanganak's digital marketing strategies have transformed our online presence. The insights and results we've gained have been invaluable for our business growth." },
    { name: "Vikram Singh", role: "Founder, BlockChain Solutions Pune", content: "The blockchain solution Sanganak developed for us has received overwhelmingly positive feedback from our clients. Their team's technical expertise and creativity are truly impressive." },
  ]
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <AnimatedSection id="portfolio">
            <SplineCard>
              <Card className="bg-white/30 dark:bg-gray-800/30 backdrop-blur-md shadow-lg mb-16">
                <CardHeader>
                  <CardTitle className="text-2xl sm:text-3xl text-center text-indigo-800 dark:text-indigo-300">
                    Our Portfolio
                  </CardTitle>
                  <CardDescription className="text-center text-sm sm:text-base">
                ...
                <CardContent>
                  <Tabs value={activePortfolioTab} onValueChange={setActivePortfolioTab} className="w-full">
                    <TabsList className="grid grid-cols-3 md:grid-cols-6 gap-1 sm:gap-2 mb-4">
                      <TabsTrigger value="marketing" className="px-1 sm:px-2 py-1 text-[10px] sm:text-xs md:text-sm">Marketing</TabsTrigger>
                      <TabsTrigger value="design" className="px-1 sm:px-2 py-1 text-[10px] sm:text-xs md:text-sm">Design</TabsTrigger>
                      <TabsTrigger value="web" className="px-1 sm:px-2 py-1 text-[10px] sm:text-xs md:text-sm">Web</TabsTrigger>
                      <TabsTrigger value="mobile" className="px-1 sm:px-2 py-1 text-[10px] sm:text-xs md:text-sm">Mobile</TabsTrigger>
                      <TabsTrigger value="blockchain" className="px-1 sm:px-2 py-1 text-[10px] sm:text-xs md:text-sm">Blockchain</TabsTrigger>
                      <TabsTrigger value="ai" className="px-1 sm:px-2 py-1 text-[10px] sm:text-xs md:text-sm">AI</TabsTrigger>
                    </TabsList>
                              ...
                              <Card className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm">
                                <CardContent className="p-2 sm:p-4">
                                  <Image
                                    ...
                                    width={300}
                                    height={200}
                                    className="w-full h-16 sm:h-24 md:h-32 object-cover rounded-md mb-1 sm:mb-2"
                                  />
                                  <h3 className="text-[10px] sm:text-xs md:text-sm font-semibold text-indigo-800 dark:text-indigo-300 truncate">
                                    {item.title}
                                  </h3>
                                </CardContent>
                              </Card>
                ...
                <CardContent>
                  <div className="flex flex-col items-center space-y-6">
                    <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                      <Button variant="outline" size="lg" className="w-full sm:w-auto bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm">
                        <Phone className="mr-2 h-4 w-4" />
                        <Link href="tel:+919631864610">
                          <span className="sr-only">Call us at +91 9631864610</span>
                          Call
                        </Link>
                      </Button>
                      <Button variant="outline" size="lg" className="w-full sm:w-auto bg-white/50 dark:bg-gray-700/50 backdrop-blur-sm">
